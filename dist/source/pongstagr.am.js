...
(function() {
  ...
  Pongstgrm.prototype.html = function() {
    ...
    this.thumb = function(context) {
      var comments_count, comments_html, created, likes_count, likes_html, username, video;
      ...
      username = that.options.username && ("" + options.data.username);
      return "<div class='pongstgrm-item'> <div class='pongstgrm-item-content'> <small class='pongstgrm-item-date'>" + created + "</small> <img class='pongstgrm-img-responsive' alt='' src='" + context.images.low_resolution.url + "' width='" + context.images.low_resolution.width + "' height='" + context.images.low_resolution.height + "'>" + video + " <div class='user-name'>" + username + "</div> <div class='pongstgrm-item-toolbar'> " + likes_html + " &nbsp; &nbsp; " + comments_html + " </div> </div> </div>";
    };
